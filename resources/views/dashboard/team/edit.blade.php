    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <x-dashboard.layouts.breadcrumb now="{{ __('dashboard.edit team') }}">
                <li class="breadcrumb-item"><a href="{{ route('admin.teams.index') }}">{{ __('dashboard.team list') }}</a>
                </li>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST"
                                action="{{ route('admin.teams.update', $team->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="first-name-icon"
                                                        value="{{ old('name_ar', $team->name_ar) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="first-name-icon" class="form-control"
                                                        value="{{ old('name_en', $team->name_en) }}" name="name_en"
                                       ...
                                       {{-- <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="url" id="first-name-icon" class="form-control"
                                                        ...
                                                        placeholder="{{ __('dashboard.linkedIn link') }}">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-grid"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label
                                                        for="first-name-icon">{{ __('dashboard.table job') . __('dashboard.in arabic') }}</label>
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="first-name-icon" class="form-control"
                                                            name="job_ar" value="{{ old('job_ar', $team->job_ar) }}"
                                                            placeholder="{{ __('dashboard.table job') . __('dashboard.in arabic') }}">
                                                        <div class="form-control-position">
                                                            <i class="feather icon-grid"></i>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <textarea rows="5" id="contact-info-icon" class="form-control" name="description_ar"
                                                            placeholder="{{ __('dashboard.table description') . __('dashboard.in arabic') }}">{{ old('description_ar', $team->description_ar) }}</textarea>
                                                        <div class="form-control-position">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <textarea rows="5" id="password-icon" class="form-control" name="description_en"
                                                            placeholder="{{ __('dashboard.table description') . __('dashboard.in english') }}">{{ old('description_en', $team->description_en) }}</textarea>
                                                        <div class="form-control-position">
                                                            <i class="fa fa-pencil"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label
                                                        for="first-name-icon">{{ __('dashboard.website link') }}</label>
                                                    <div class="position-relative has-icon-left">
                                                        <input type="url" id="first-name-icon" class="form-control"
                                                            name="website" value="{{ old('website', $team->website) }}"
                                                            placeholder="{{ __('dashboard.website link') }}">
                                                        <div class="form-control-position">
                                                            <i class="feather icon-grid"></i>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label
                                                    for="first-name-icon">{{ __('dashboard.facebook link') }}</label>
                                                <div class="position-relative has-icon-left">
                                                    <input type="url" id="first-name-icon" class="form-control"
                                                        name="facebook" value="{{ old('facebook', $team->facebook) }}"
                                                        placeholder="{{ __('dashboard.behance link') }}">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-grid"></i>
                                                    </div>
                                                </div>
