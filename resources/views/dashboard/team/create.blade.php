            ...
            <div class="col-12 mt-3">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST" action="{{ route('admin.teams.store') }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <textarea rows="5" id="contact-info-icon" class="form-control" name="description_ar"
                                                            placeholder="{{ __('dashboard.table description') . __('dashboard.in arabic') }}"></textarea>
                                                        <div class="form-control-position">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <textarea rows="5" id="password-icon" class="form-control" name="description_en"
                                                            placeholder="{{ __('dashboard.table description') . __('dashboard.in english') }}"></textarea>
                                                        <div class="form-control-position">
                                                            <i class="fa fa-pencil"></i>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="url" id="first-name-icon" class="form-control"
                                                        name="facebook"
                                                        placeholder="{{ __('dashboard.facebook link') }}">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-grid"></i>
                                                    </div>
                                                </div>
